...
<!-- Mirrored from mizzle.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 08:20:14 GMT -->
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
          <ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle active" href="#" data-bs-auto-close="outside" data-bs-toggle="dropdown"
                ...
                <div class="row pt-2">
                  ...
                  <div class="col-sm-6">
                    <ul class="list-unstyled">
                      <li> <a class="dropdown-item active" href="index-2.html">Classic Default</a> </li>
                      <li> <a class="dropdown-item" href="index-creative-agency.html">Creative Agency</a> </li>
                      <li> <a class="dropdown-item" href="index-digital-agency.html">Digital Agency<span
                            class="badge text-bg-success ms-2">New</span></a> </li>
                      <li> <a class="dropdown-item" href="index-design-agency.html">Design Agency<span
                            class="badge text-bg-success ms-2">New</span></a> </li>
                      <li> <a class="dropdown-item" href="index-seo-agency.html">SEO Agency<span
                            class="badge text-bg-success ms-2">New</span></a> </li>
                  ...
                  <div class="col-sm-6">
                    <ul class="list-unstyled">
                      ...
                      <li> <a class="dropdown-item" href="index-finance-consulting.html">Finance consulting<span
                            class="badge text-bg-success ms-2">New</span></a> </li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="dropdown dropend">
                  ...
                  <ul class="dropdown-menu" data-bs-popper="none">
                    ...
                    <li> <a class="dropdown-item" href="career.html">Career <span class="badge text-bg-primary ms-2">2
                          Job</span></a></li>
                ...
                <!-- Dropdown submenu -->
                <li class="dropdown dropend">
                  <a class="nav-link dropdown-link dropdown-toggle" data-bs-toggle="dropdown" href="#">Specialty
                    Pages</a>
                  <ul class="dropdown-menu" data-bs-popper="none">
                ...
                <div class="row g-xl-3">
                    ...
                    <div class="d-flex gap-4">
                      ...
                      <div class="card bg-transparent">
                        ...
                        <div class="card-body px-0 text-start pb-0">
                          ...
                          <a class="icon-link icon-link-hover stretched-link mb-0"
                            href="portfolio-case-studies-v1.html">Learn more<i class="bi bi-arrow-right"></i> </a>
                        </div>
                      </div>
                      ...
                      <div class="card bg-transparent">
                        ...
                        <div class="card-body px-0 text-start pb-0">
                          ...
                          <p class="mb-2 small">We help our customers better manage their web presence.</p>
                          <a class="icon-link icon-link-hover stretched-link mb-0"
                            href="portfolio-case-studies-v2.html">Learn more<i class="bi bi-arrow-right"></i> </a>
                        </div>
                      </div>
                  ...
                  <div class="col-xl-4">
                    <ul class="list-unstyled">
                      ...
                      <li> <a class="dropdown-item" href="portfolio-case-studies-v1.html">Portfolio Case Study v.1</a>
                      </li>
                      <li> <a class="dropdown-item" href="portfolio-case-studies-v2.html">Portfolio Case Study v.2</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <li class="nav-item dropdown dropdown-fullwidth">
              <a class="nav-link dropdown-toggle" href="#" id="megaMenu" data-bs-toggle="dropdown" aria-haspopup="true"
                ...
                <div class="row p-2 p-sm-4 g-4">
                  ...
                  <div class="col-md-6 col-xl-3">
                    ...
                    <div class="dropdown-item d-flex bg-light-hover position-relative text-wrap py-3">
                      ...
                      <div class="ms-2">
                        <a class="stretched-link heading-color fw-bold mb-0" href="#">Career<span
                            class="badge text-bg-primary ms-2">3 Jobs</span></a>
                    ...
                    <div class="dropdown-item d-flex bg-light-hover position-relative text-wrap py-3">
                      ...
                      <div class="ms-2">
                        ...
                        <p class="mb-0 text-body small">Learn how our customer are making big changes to their tech
                          stack</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-xl-3">
                    ...
                    <div class="dropdown-item bg-light-hover d-flex align-items-sm-center gap-2 position-relative mb-3">
                      ...
                      <p class="text-wrap fw-bold mb-0"><a href="blog-single-v1.html"
                          class="stretched-link heading-color text-primary-hover">10 things you need to know about
                          Mizzle</a></p>
                    </div>
                    ...
                    <div class="dropdown-item bg-light-hover d-flex align-items-sm-center gap-2 position-relative mb-3">
                      ...
                      <p class="text-wrap fw-bold mb-0"><a href="blog-single-v2.html"
                          class="stretched-link heading-color text-primary-hover">The Power of Gratitude: Cultivating
                          Joy and Abundance</a></p>
                    </div>
                    ...
                    <div class="dropdown-item bg-light-hover d-flex align-items-sm-center gap-2 position-relative">
                      ...
                      <p class="text-wrap fw-bold mb-0"><a href="blog-single-v1.html"
                          class="stretched-link heading-color text-primary-hover">Effortless Web Development with
                          Mizzle</a></p>
                    </div>
      ...
      <div class="container pt-4 pt-sm-5">
        <div class="row g-xl-5">
          ...
          <div class="col-xl-7 mb-5 mb-xl-0">
            <div class="pe-xxl-4">
              <span class="heading-color d-inline-block bg-light small rounded-3 px-3 py-2">🤩 Award-winning digital
                services</span>
          ...
          <div class="col-md-10 col-xl-5 position-relative mx-auto mt-7 mt-xl-0">
            ...
            <div
              ...
              <img src="assets/images/elements/trustpilot-light.svg" class="dark-mode-item h-20px mb-2"
                alt="Client-img">
              <div class="d-flex align-items-center">
      ...
      <div class="container">
        <div class="row g-4 align-items-xl-center">
          ...
          <div class="col-lg-5">
            ...
            <p class="mb-4">Embrace a new era of digital success with Mizzle. Our team combines cutting-edge design with
              robust development to deliver websites that captivate and convert.</p>
            <!-- List -->
            <ul class="list-group list-group-borderless mb-4">
              <li class="list-group-item heading-color d-flex mb-0"><i
                  class="bi bi-patch-check-fill text-primary me-2"></i>Emphasis on ROI-driven solutions</li>
              <li class="list-group-item heading-color d-flex mb-0"><i
                  class="bi bi-patch-check-fill text-primary me-2"></i>Expert team with diverse skill</li>
              <li class="list-group-item heading-color d-flex mb-0"><i
                  class="bi bi-patch-check-fill text-primary me-2"></i>Proven track record of delivering results</li>
            </ul>
            <!-- Button -->
              ...
              <div class="row text-center text-sm-start">
                ...
                <div class="col-sm-6">
                  <div class="d-flex justify-content-between mb-4 mb-sm-0">
                    <div>
                      <!-- Svg image -->
                      <figure>
                        <svg width="120px" height="156px" viewBox="0 0 120 156"
                          style="enable-background:new 0 0 120 156;" xml:space="preserve">
                ...
                <div class="col-sm-6 ps-md-5">
                  ...
                  <ul class="list-group list-group-borderless mb-3 mb-sm-4">
                    <li class="list-group-item heading-color mb-0"><i class="bi bi-check-lg text-primary me-1"></i>Up to
                      05 users monthly</li>
                    <li class="list-group-item heading-color mb-0"><i class="bi bi-check-lg text-primary me-1"></i>Free
                      5 host & domain</li>
                    <li class="list-group-item heading-color mb-0"><i
                        class="bi bi-check-lg text-primary me-1"></i>Google Docs style editors</li>
                    <li class="list-group-item heading-color mb-0"><i
                        class="bi bi-check-lg text-primary me-1"></i>Support for 30+ languages</li>
                    <li class="list-group-item heading-color mb-0"><i
                        class="bi bi-check-lg text-primary me-1"></i>Landing pages & Web widgets</li>
                    <li class="list-group-item heading-color mb-0"><i class="bi bi-check-lg text-primary me-1"></i>24/7
                ...
                <div class="swiper-slide">
                  <div class="card bg-transparent h-100">
                    <div class="card-body p-0">
                      ...
                      <!-- Content -->
                      <p class="heading-color fw-normal">Mizzle is the perfect theme for businesses that want to create
                        a stylish and functional website.</p>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="card bg-transparent h-100">
                    <div class="card-body p-0">
                      ...
                      <!-- Content -->
                      <p class="heading-color fw-normal">The best Bootstrap theme we've ever used - it's easy to
                        customize and comes with all the features we need.</p>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="card bg-transparent h-100">
                    <div class="card-body p-0">
                      ...
                      <!-- Content -->
                      <p class="heading-color fw-normal">Webestica helped us create a stunning website that reflects our
                        brand perfectly.</p>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="card bg-transparent h-100">
                    <div class="card-body p-0">
                      ...
                      <!-- Content -->
                      <p class="heading-color fw-normal">I highly recommend Mizzle to anyone looking for a high-quality
                        Bootstrap theme.</p>
                    </div>
    ...
    <div class="container position-relative mt-5">
      ...
      <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
        ...
        <div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
          <a class="dropdown-toggle btn btn-sm btn-light mb-0" href="#" role="button" id="languageSwitcher"
            data-bs-toggle="dropdown" aria-expanded="false">
            <i class="fas fa-globe me-2"></i>Language
          </a>
          <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/uk.svg"
                  alt="">English</a></li>
            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/gr.svg"
                  alt="">German </a></li>
            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/sp.svg"
                  alt="">French</a></li>
          </ul>
        </div>
      </div>
...
<!-- Mirrored from mizzle.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 08:20:41 GMT -->
